...
// Définir toutes les fonctions de formatage avant leur utilisation
...
// Définir les fonctions de récupération de données
    ...
    if (message.content.trim().toLowerCase() === '!vixagent') {
      ...
      **🎯 Signal Trading ES :**
      ...
      💹 *ES Futures Analysis | ${(() => {
        ...
        if (message1.length <= 1800) {
          // Laisser de la marge pour le second message
