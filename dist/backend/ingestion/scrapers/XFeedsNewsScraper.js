        ...
        try {
            ...
            for (const feed of selectedFeeds) {
                ...
                try {
                    ...
                    const feedItems = await Promise.all(entries.map(async (element) => {
                    ...
                    console.error(`Failed to fetch X feed ${feed.title}:`, err instanceof Error ? err.message : String(err));
                }
            }
            return allNews;
        }
...
//# sourceMappingURL=XFeedsNewsScraper.js.map